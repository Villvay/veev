...
<?php 				});
		...
		function renderACLRow($path, $module, $data, $indent){ ?>
				<tr class="level-<?php echo $indent; ?>">
					...
					<td><input type="checkbox" name="auth[<?php echo $path.$module[0]; ?>][full]"<?php echo isset($data[$path.$module[0]]['full'])?' checked':''; ?> onclick="aclSelect(this);" /></td>
					<td><input type="checkbox" name="auth[<?php echo $path.$module[0]; ?>][view]"<?php echo isset($data[$path.$module[0]]['view'])?' checked':''; ?> onclick="aclSelect(this);" /></td>
					<td><input type="checkbox" name="auth[<?php echo $path.$module[0]; ?>][add]"<?php echo isset($data[$path.$module[0]]['add'])?' checked':''; ?> onclick="aclSelect(this);" /></td>
					<td><input type="checkbox" name="auth[<?php echo $path.$module[0]; ?>][edit]"<?php echo isset($data[$path.$module[0]]['edit'])?' checked':''; ?> onclick="aclSelect(this);" /></td>
					<td><input type="checkbox" name="auth[<?php echo $path.$module[0]; ?>][delete]"<?php echo isset($data[$path.$module[0]]['delete'])?' checked':''; ?> onclick="aclSelect(this);" /></td>
				</tr>
